...
class GameOverlay:
    ...
    def __init__(self, scale, max_hp, max_mana, center_x, center_y):
        ...
        self.inventory_pos = (center_x - self.inventory.get_width() / 2, center_y * 2 - self.inventory.get_height() - corner_margin)
    ...
    def draw_hp_and_mana(self, display, hp, mana):
        ...
        display.blit(pygame.transform.scale(self.mana_bar, (mana_draw_width, self.mana_bar.get_height())), self.mana_bar_pos)
        pass
